...
class Turma(models.Model):
    ...
    horario_inicio = models.TimeField(verbose_name="Horário de Início", default='06:00')  # Adiciona um valor padrão
    horario_fim = models.TimeField(verbose_name="Horário de Fim", default='07:00')  # Adiciona um valor padrão
